...
public class AppKeyboardView extends View implements View.OnClickListener , OnFontEmojiListener{
    ...
    private AppKeyboardView mMiniKeyboard;
    private boolean mMiniKeyboardOnScreen;
    private View mPopupParent;
    private int mMiniKeyboardOffsetX;
    private int mMiniKeyboardOffsetY;
    private Map<AppKeyboard.Key,View> mMiniKeyboardCache;
    private AppKeyboard.Key[] mKeys;
    ...
    public AppKeyboardView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, R.attr.AppkeyboardViewStyle);

    }

    public AppKeyboardView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        this(context, attrs, defStyleAttr, 0);
    }

    public AppKeyboardView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        super(context, attrs, defStyleAttr, defStyleRes);
        this.mContext= context;
        TypedArray a = mContext.obtainStyledAttributes(attrs, R.styleable.AppKeyboardView, defStyleAttr, defStyleRes);
        ...
        for (int i = 0; i < n; i++) {
            ...
            switch (attr) {
                case R.styleable.AppKeyboardView_keyBackground:
                    mKeyBackground = a.getDrawable(attr);
                    break;
                case R.styleable.AppKeyboardView_verticalCorrection:
                    mVerticalCorrection = a.getDimensionPixelOffset(attr, 0);
                    break;
                case R.styleable.AppKeyboardView_keyPreviewLayout:
                    previewLayout = a.getResourceId(attr, 0);
                    break;
                case R.styleable.AppKeyboardView_keyPreviewOffset:
                    mPreviewOffset = a.getDimensionPixelOffset(attr, 0);
                    break;
                case R.styleable.AppKeyboardView_keyPreviewHeight:
                ...
                case R.styleable.AppKeyboardView_popupLayout:
                    ...
                    break;
                case R.styleable.AppKeyboardView_shadowColor:
                    mShadowColor = a.getColor(attr, 0);
                    break;
                case R.styleable.AppKeyboardView_shadowRadius:
        ...
        mMiniKeyboardCache = new HashMap<AppKeyboard.Key,View>();
        ...
        mAudioManager = (AudioManager) context.getSystemService(mContext.AUDIO_SERVICE);
    ...
    public void setKeyboard(AppKeyboard keyboard) {
        ...
        removeMessages();
        mKeyboard = keyboard;
        List<AppKeyboard.Key> keys = mKeyboard.getKeys();
        mKeys = keys.toArray(new AppKeyboard.Key[keys.size()]);
        requestLayout();
     ...
     * @see #setKeyboard(AppKeyboard)
     */
    public AppKeyboard getKeyboard() {
        return mKeyboard;
    }
     ...
     * @see AppKeyboardView#setShifted(boolean)
     */
    ...
    /**
     * When enabled, calls to {@link AppKeyboardView.OnKeyboardActionListener#onKey} will include key
     ...
     * @param keyboard
     */
    private void computeProximityThreshold(AppKeyboard keyboard) {
    ...
    private void onBufferDraw() {
        ...
        //final int kbdPaddingLeft = 1;
        // final int kbdPaddingTop = 1;
        final AppKeyboard.Key[] keys = mKeys;
        ...
        for (int i = 0; i < keyCount; i++) {
            final AppKeyboard.Key key = keys[i];
    ...
    private int getKeyIndices(int x, int y, int[] allKeys) {
        ...
        for (int i = 0; i < keyCount; i++) {
            final AppKeyboard.Key key = keys[nearestKeyIndices[i]];
            int dist = 0;
    ...
    private void detectAndSendKey(int index, int x, int y, long eventTime) {
        if (index != NOT_A_KEY[0] && index < mKeys.length) {
            ...
            if (key.text != null) {
                ...
                if (mInMultiTap) {
                    if (mTapCount != -1) {
                        mKeyboardActionListener.onKey(AppKeyboard.KEYCODE_DELETE, KEY_DELETE);
                    } else {
                        mTapCount = 0;
                    }
     ...
     */
    private CharSequence getPreviewText(AppKeyboard.Key key) {
        if (mInMultiTap) {
            // Multi-tap
    ...
    private void showKey(final int keyIndex) {
        ...
        AppKeyboard.Key key = keys[keyIndex];
        if (key.icon != null) {
    ...
    private void sendAccessibilityEventForUnicodeCharacter(int eventType, int code) {
        if (mAccessibilityManager.isEnabled()) {
            ...
            final String text;
            switch (code) {
                case AppKeyboard.KEYCODE_ALT:
                    text = mContext.getString(R.string.app_keyboard_view_keycode_alt);
                    break;
                ...
                case AppKeyboard.KEYCODE_DONE:
                    text = mContext.getString(R.string.app_keyboard_view_keycode_done);
                    break;
                case AppKeyboard.KEYCODE_MODE_CHANGE:
                    text = mContext.getString(R.string.app_keyboard_view_keycode_mode_change);
                    break;
                case AppKeyboard.KEYCODE_SHIFT:
                    text = mContext.getString(R.string.app_keyboard_view_keycode_shift);
                    break;
                case '\n':
                    text = mContext.getString(R.string.app_keyboard_view_keycode_enter);
                    break;
                default:
     ...
     * may not be honored.
     * @param keyIndex the index of the key in the attached {@link AppKeyboard}.
    ...
    public void invalidateKey(int keyIndex) {
        ...
        final AppKeyboard.Key key = mKeys[keyIndex];
        mInvalidatedKey = key;
    ...
    private boolean openPopupIfRequired(MotionEvent me) {
        ...
        AppKeyboard.Key popupKey = mKeys[mCurrentKey];
    ...
    protected boolean onLongPress(AppKeyboard.Key popupKey) {
        ...
        /*if (popupKeyboardId != 0) {
            ...
            if (mMiniKeyboardContainer == null) {
                ...
                mMiniKeyboard = (AppKeyboardView) mMiniKeyboardContainer.findViewById(R.id.appKeyboardView);
                ...
                if (popupKey.popupCharacters != null) {
                    keyboard = new AppKeyboard(getContext(), popupKeyboardId,
    ...
    private boolean repeatKey() {
        AppKeyboard.Key key = mKeys[mRepeatKeyIndex];
